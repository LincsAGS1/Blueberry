...
public class HealthScript : MonoBehaviour 
{
	...
	void Start () 
	{
		BlueTint = GameObject.FindGameObjectWithTag ("tint"); 
		BlueTint2 = GameObject.FindGameObjectWithTag ("tint 2"); 
	}
	
	// Update is called once per frame
	void Update () 
	{
		if (this.GetComponent<AgentManager>().infected == true && this.name == "Player 1") 
		...
		else if (this.name == "Player 1" && this.GetComponent<AgentManager>().infected == false)
		...
		if (this.GetComponent<AgentManager>().infected == true && this.name == "Player 2") 
		...
		else if (this.name == "Player 2" && this.GetComponent<AgentManager>().infected == false)
